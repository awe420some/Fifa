...
export const I18N = {
  en: {
    ...
    playerCols: { rank: "#", name: "Player", team: "Team", expGoals: "E[goals]", expAssists: "E[assists]", pAny: "P(scores ≥1 in WC)", pBoot: "P(Golden Boot)" },
  ...
  de: {
    ...
    playersTeamFilter: "Team-Filter",
    playerCols: { rank: "#", name: "Spieler", team: "Team", expGoals: "Ø Tore", expAssists: "Ø Assists", pAny: "P(≥1 Tor in WM)", pBoot: "P(Goldener Schuh)" },
