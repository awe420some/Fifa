...
export const I18N = {
  en: {
    ...
    pools: {
      ...
      poolName: "Name",
      poolType: "Type",
      typePnl: "Odds betting",
      typeBracket: "Champion tip",
      typeCtp: "Score tipping",
      colTip: "Tip",
      tipsCount: "tips",
      buyIn: "Buy-in",
      endsAt: "Ends",
      ...
      pickChampionHeader: "Your champion pick",
      pickChampionPrompt: "pick a team",
      pickChampionHint: "Worth 1 point if your team lifts the trophy.",
      pickScoreHeader: "Your score predictions",
      pickScoreHint: "5 pts exact · 3 pts outcome + total · 1 pt outcome.",
      pickScoreSave: "Save",
      pickScorePoints: "pts",
      pickScoreNone: "No matches in this pool window.",
    },
    friends: {
      section: "Friends",
      intro: "See everyone's bets and the live leaderboard below.",
      loginEmail: "Email",
      loginButton: "Send magic link",
      loginPending: "Check your inbox — magic link sent.",
      pwHint: "Sign in with email + password — you stay logged in across reloads and devices.",
      name: "Name",
      password: "Password",
      signin: "Sign in",
      signup: "Request membership",
      signupHint: "New here? \"Request membership\" sends a request — the admin approves you.",
      signupOk: "Request sent — waiting for approval.",
      altHeader: "Other options",
      resetButton: "Forgot password?",
      resetSent: "Reset email sent — check your inbox.",
      recoveryHint: "Set a new password for your account.",
      newPassword: "New password",
      newPwSave: "Save password",
      pwTooShort: "Password needs ≥ 6 characters.",
      confirmHint: "Account created — please confirm your email.",
      magicErr: "Magic link failed (rate limit?). Try email + password.",
      emailMissing: "Enter your email.",
      pwMissing: "Enter email + password.",
      awaitingApproval: "Request sent — waiting for the admin to approve you.",
      rejected: "Your access request was declined.",
      roomPending: "Join request sent — waiting for the room owner.",
      adminHeader: "Membership requests",
      adminNoRequests: "No open membership requests.",
      roomRequestsHeader: "Join requests",
      approve: "Approve",
      reject: "Reject",
      signout: "Sign out",
      nickname: "Nickname",
      ...
      colEdge: "Avg edge",
      last5: "Last 5",
      noMembers: "No players in the round yet.",
      inRound: "You're in the betting round — see all pools, tips and the ranking below.",
      loadingRound: "Loading the round…",
    ...
    auth: {
      ...
      recoveryHeading: "New password",
      newPassword: "New password",
      newPwSave: "Save password",
      pendingTitle: "Almost there",
      pendingBody: "Your account is being reviewed — the admin will let you in. You'll get access as soon as it's approved.",
      rejected: "Your access request was declined.",
      signupOk: "Request sent — waiting for approval.",
      logout: "Sign out",
    },
  ...
  de: {
    ...
    pools: {
      ...
      poolName: "Name",
      poolType: "Typ",
      typePnl: "Quoten-Wetten",
      typeBracket: "Weltmeister-Tipp",
      typeCtp: "Ergebnis-Tipp",
      colTip: "Tipp",
      tipsCount: "Tipps",
      buyIn: "Buy-in",
      endsAt: "Ende",
      ...
      pickChampionHeader: "Dein Champion-Tipp",
      pickChampionPrompt: "Team wählen",
      pickChampionHint: "1 Punkt wenn dein Team den Pott holt.",
      pickScoreHeader: "Deine Spielstand-Tipps",
      pickScoreHint: "5 Pkt exakt · 3 Pkt Ausgang + Tore · 1 Pkt Ausgang.",
      pickScoreSave: "Speichern",
      pickScorePoints: "Pkt",
      pickScoreNone: "Keine Spiele im Pool-Zeitraum.",
    },
    friends: {
      section: "Freunde",
      intro: "Hier siehst du eure Wetten + die Live-Rangliste.",
      loginEmail: "Email",
      loginButton: "Magic-Link senden",
      loginPending: "Check deine Inbox — Magic-Link gesendet.",
      pwHint: "Anmelden mit Email + Passwort — du bleibst eingeloggt, auch nach Reload und auf anderen Geräten.",
      name: "Name",
      password: "Passwort",
      signin: "Anmelden",
      signup: "Mitglied werden",
      signupHint: "Neu hier? Mit „Mitglied werden“ sendest du eine Anfrage — der Admin gibt dich frei.",
      signupOk: "Anfrage gesendet — warte auf Freigabe.",
      altHeader: "Andere Optionen",
      resetButton: "Passwort vergessen?",
      resetSent: "Reset-Mail gesendet — check deine Inbox.",
      recoveryHint: "Setze ein neues Passwort für deinen Account.",
      newPassword: "Neues Passwort",
      newPwSave: "Passwort speichern",
      pwTooShort: "Passwort braucht ≥ 6 Zeichen.",
      confirmHint: "Account erstellt — bitte Email bestätigen.",
      magicErr: "Magic-Link fehlgeschlagen (Rate-Limit?). Nutze Email + Passwort.",
      emailMissing: "Email eintragen.",
      pwMissing: "Email + Passwort eintragen.",
      awaitingApproval: "Anfrage gesendet — warte auf Freigabe durch den Admin.",
      rejected: "Dein Zugang wurde leider abgelehnt.",
      roomPending: "Beitritt gesendet — warte auf Freigabe durch den Raum-Owner.",
      adminHeader: "Mitglieds-Anfragen",
      adminNoRequests: "Keine offenen Mitglieds-Anfragen.",
      roomRequestsHeader: "Beitritts-Anfragen",
      approve: "Freigeben",
      reject: "Ablehnen",
      signout: "Abmelden",
      nickname: "Spitzname",
      ...
      colEdge: "Ø Edge",
      last5: "Letzte 5",
      noMembers: "Noch keine Mitspieler in der Runde.",
      inRound: "Du bist in der Wettrunde — unten siehst du alle Pools, alle Tipps und die Rangliste.",
      loadingRound: "Wettrunde wird geladen…",
    ...
    auth: {
      ...
      toSignup: "Noch kein Konto? Konto erstellen",
      toSignin: "Schon dabei? Anmelden",
      forgot: "Passwort vergessen?",
      recoveryHeading: "Neues Passwort",
      newPassword: "Neues Passwort",
      newPwSave: "Passwort speichern",
      pendingTitle: "Fast geschafft",
      pendingBody: "Dein Konto wird geprüft — der Admin gibt dich frei. Du kommst rein, sobald’s durch ist.",
      rejected: "Dein Zugang wurde leider abgelehnt.",
      signupOk: "Anfrage gesendet — warte auf Freigabe.",
      logout: "Abmelden",
    },
