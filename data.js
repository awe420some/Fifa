...
export const I18N = {
  en: {
    ...
    friends: {
      ...
      anonHint: "One-click login, no email — recommended for family pools.",
      anonButton: "Anonymous login",
      emailHeader: "Or use email (magic link)",
      pwHint: "Sign in with email + password — you stay logged in across reloads and devices.",
      password: "Password",
      signin: "Sign in",
      signup: "Create account",
      altHeader: "Other login options",
      pwMissing: "Enter email + password.",
      signupOk: "Account created and signed in.",
      anonymousLabel: "Guest",
      anonError: "Anonymous sign-in is disabled in Supabase. Enable it in Authentication → Sign In / Providers → Anonymous.",
      signout: "Sign out",
      nickname: "Nickname",
  ...
  de: {
    ...
    friends: {
      ...
      anonHint: "Ein-Klick-Login ohne Email — empfohlen für Family-Pools.",
      anonButton: "Anonymer Login",
      emailHeader: "Lieber mit Email (Magic-Link)",
      pwHint: "Anmelden mit Email + Passwort — du bleibst eingeloggt, auch nach Reload und auf anderen Geräten.",
      password: "Passwort",
      signin: "Anmelden",
      signup: "Konto erstellen",
      altHeader: "Andere Login-Optionen",
      pwMissing: "Email + Passwort eintragen.",
      signupOk: "Account erstellt und eingeloggt.",
      anonymousLabel: "Gast",
      anonError: "Anonymous Sign-In ist in Supabase deaktiviert. Aktiviere es in Authentication → Sign In / Providers → Anonymous.",
      signout: "Abmelden",
      nickname: "Spitzname",
