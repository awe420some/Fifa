...
export const I18N = {
  en: {
    ...
    dateLabel: "Pick a date — your birthday, an anniversary, anything",
    dateHint: "The oracle reads the date itself — calendar omens, lucky digit, distance to kickoff.",
    decode: "Decode",
    decoding: "Decoding…",
    ...
    // What-if-Modus
    whatIfHint: "Click any team in the bracket to flip that match — the bracket re-simulates downstream.",
    whatIfBanner: (n) => `What-if active — ${n} match${n === 1 ? "" : "es"} flipped.`,
    whatIfReset: "Reset what-if",
    whatIfBadge: "what-if",
    whatIfTag: "WHAT-IF",
    // History
    historyOpen: "History",
    historyTitle: "Reading History",
    historyEmpty: "No past readings yet.",
    historyClear: "Clear",
    historyClearConfirm: "Clear all past readings?",
    historyChampion: "Champion",
    historyFromText: "Text",
    historyFromSeed: "Seed",
    ...
    // Date-Decoder
    sectionDateLens: "Date Lens",
    dateWeekday: "Weekday",
    dateLuckyDigit: "Lucky digit",
    dateToKickoff: "Days to opening match",
    dateKickoffPast: "days since opening match",
    dateAtKickoff: "Kickoff day itself!",
    dateInvalid: "Pick a valid calendar date for the reading.",
    dateOmenPast: (year) => `Mirror of ${year} — the calendar shape repeats.`,
    dateOmenFuture: (days) => `${days} sunrises until the opening whistle in Mexico City.`,
  ...
  de: {
    ...
    seedPlaceholder: "Lionel 24-06-1987",
    dateLabel: "Datum wählen — Geburtstag, Jahrestag, alles",
    dateHint: "Das Orakel liest das Datum selbst — Kalenderomen, Glückszahl, Tage bis zum Anpfiff.",
    ...
    // What-if-Modus
    whatIfHint: "Klicke ein Team im Bracket an, um das Spiel zu drehen — alles dahinter wird neu simuliert.",
    whatIfBanner: (n) => `Was-wäre-wenn aktiv — ${n} ${n === 1 ? "Spiel" : "Spiele"} gedreht.`,
    whatIfReset: "Was-wäre-wenn zurücksetzen",
    whatIfBadge: "was-wäre-wenn",
    whatIfTag: "WAS-WÄRE-WENN",
    // History
    historyOpen: "Verlauf",
    historyTitle: "Lese-Verlauf",
    historyEmpty: "Noch keine Deutungen im Verlauf.",
    historyClear: "Leeren",
    historyClearConfirm: "Alle bisherigen Deutungen löschen?",
    historyChampion: "Weltmeister",
    historyFromText: "Text",
    historyFromSeed: "Seed",
    historyFromDate: "Datum",
    ...
    // Date-Decoder
    sectionDateLens: "Datums-Linse",
    dateWeekday: "Wochentag",
    dateLuckyDigit: "Glückszahl",
    dateToKickoff: "Tage bis zum Anpfiff",
    dateKickoffPast: "Tage seit dem Anpfiff",
    dateAtKickoff: "Genau der Anpfiff-Tag!",
    dateInvalid: "Wähle ein gültiges Kalenderdatum für die Deutung.",
    dateOmenPast: (year) => `Spiegel des Jahres ${year} — der Kalender wiederholt sich.`,
    dateOmenFuture: (days) => `${days} Sonnenaufgänge bis zum Eröffnungsspiel in Mexiko-Stadt.`,
